...
export default function Button({ text, btnIcon, btnStyle }) {
	...
	return (
		<>
			<button className={btnStyle}><FontAwesomeIcon className="btnIcon" icon={iconSelection(btnIcon)}/>{text}</button>
		</>
	)
}