        ...
        <div className="found-box">
            ...
            <form ref={form} noValidate>
                <div className="found-container">
                    <div className="found-add-left">
                        ...
                        <div>
                            ...
                            <Field type="text" name="breed" placeholder="Type breed" error={errors.breed}/>
                        </div>
                        <div>
                            <label htmlFor="color">Color:</label>
                            <Field type="text" name="color" placeholder="Type color" error={errors.color}/>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea name="features" placeholder="Type features" error={errors.features}/>
                        </div>
                        <div>
                            <label htmlFor="description">Description:<br/><span>up to 150 char</span></label>
                            <textarea name="description" placeholder="Type description" error={errors.description}/>
                        </div>
                        <div>
                            <label htmlFor="location">Location: </label>
                            <textarea name="location" placeholder="Type location" error={errors.location}/>
                        </div>
                    </div>
                    <div className="found-add-right">
                        <div className="found-add-image"><img src={Image} alt="pet"/></div>
                        <div className="found-add-btn">
                            <Field type="text" placeholder="load image" value={file}  error={errors.image} disabled/>
                            <div className="found-load-btn">
                                <Field className="btn-1" type="file" name="image" onChange={onChangeHandler} />
                                <Field className="btn-2" value="Load image" type="text"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="found-contacts">
                    ...
                    <Field type="text" name="phone" placeholder="Phone" error={errors.phone}/>
                    <Field type="text" name="email" placeholder="Email" error={errors.email}/>
                </div>
                <div className="found-publish">
                    <Button text="Publish" icon={faPaw} color="btn" name="publish"/>
                </div>
            </form>
        </div>
    );
